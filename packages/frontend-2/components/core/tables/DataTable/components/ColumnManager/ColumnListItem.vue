...
const emit = defineEmits<{
  add: [column: TableColumnDef]
  remove: [column: TableColumnDef]
  'drag-start': [event: DragEvent, column: TableColumnDef]
  'drag-end': [event: DragEvent]
  'drag-enter': [event: DragEvent]
  drop: [event: DragEvent]
  'visibility-change': [column: TableColumnDef, visible: boolean]
}>()
